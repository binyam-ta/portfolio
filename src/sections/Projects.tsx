...
export const ProjectsSection = () => {
  return <section className="pb-16">
    <div className="container">
      ...
      <p className="text-center mt-4 md:text-lg text-white/60 max-w-md mx-auto">see how I transformed concepts into engaging digital experience.</p>
      <div className="flex flex-col gap-20 mt-10">
        {portfolioProjects.map(project => (
          <div key={project.title} className="bg-gray-800 rounded-3xl 
          relative z-0 after:z-10 overflow-hidden 
          after:content-[''] after:absoluter:inset-0
           ...
           after:pointer-events-none">
            ...
            h-12 w-full rounded-xl font-semibold inline-flex items-center
