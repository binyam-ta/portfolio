...
export const HeroSection = () => {
  ...
  <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <div className="border border-red-500 size-[800px] inline-flex animate-spin [animation-duration:20s]">
   ...
   <div className="container">
    ...
    <h1 className='font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide'>Building Exceptional Web Applications</h1>
    <p className='mt-4 text-center text-white/6'>
